...
print ("--- Informasi Mobil Ayah ---")
print ( "Berapa Jumlah Pintu Mobil Ayah: ", mobil_ayah.dor)
print ( "Jenis Mesin Mobil Ayah: ", mobil_ayah.type_engine)
```
...
mobil_baru = Mobil()
print("--- Informasi Mobil Baru ---")
print("Jenis mobil baru :", mobil_baru.jenis_mobil)
print ("Warna Mobil : ", mobil_baru.warna_mobil)
```
